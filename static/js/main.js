		        ...
		        $(form).ajaxSubmit({
		            ...
		            success: function() {
		                $(".contact-form").fadeTo( "slow", 1, function() {
		                    ...
		                    $("form#contact-form").append('<div id="succ-message" class="col-xs-12"><div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong>Your message has been sent, I will get back to you as soon as possible!</strong></div></div>').slideDown(
		                    "slow", function() {

		                      });
		                      // Animation complete.
		                      //$("#succ-message").hide(4000);
		            ...
		            error: function() {
		                $(".contact-form").fadeTo( "slow", 1, function() {
		                    ...
		                    $("form#contact-form").append('<div class="col-xs-12"><div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong style="color:red";>Problem occured, try again later!</strong></div></div>');
